...
<div class="flex justify-center items-center text-center text-xl md:text-2xl min-w-screen my-4">
    <a href="{{route("reports.prayer")}}" class="w-1/3 md:w-1/6 border-2 border-gray-500 rounded-xl mx-4 bg-gray-100">Namaz
        Raporları</a>
    <a href="{{route("reports.study")}}" class="w-1/3 md:w-1/6 border-2 border-gray-500 rounded-xl mx-4 bg-gray-100">Etüt
        Raporları</a>
    <a href="{{route("reports.sleep")}}" class="w-1/3 md:w-1/6 border-2 border-gray-500 rounded-xl mx-4 bg-gray-100">Yat
        Raporları</a>
</div>
<div class="px-4 md:px-16 items-center justify-center text-center min-h-screen min-w-screen pb-36 text-xl md:text-2xl">
